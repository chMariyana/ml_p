...
class Optimiser(object):
    ...
    def __init__(self, model, error, scheduler,learning_rule, train_dataset,
    ...
    def do_training_epoch(self):
       ...
       # scheduler = CosineAnnealingWithWarmRestarts(min_learning_rate=0.0001, max_learning_rate=0.01,
        ...
        self.scheduler.update_learning_rule(self.learning_rule,self.epoch_number)
        print(self.learning_rule.learning_rate)
